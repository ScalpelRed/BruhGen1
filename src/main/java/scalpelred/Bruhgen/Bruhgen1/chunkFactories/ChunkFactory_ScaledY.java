...
import scalpelred.Bruhgen.Bruhgen1.chunkGenerators.ChunkGenerator_ScaledY;
...
public record ChunkFactory_ScaledY() implements ForgeWorldPreset.IChunkGeneratorFactory {
    ...
    public ChunkGenerator createChunkGenerator(RegistryAccess registryAccess,
        ...
        return new ChunkGenerator_ScaledY(
                structureSets,
                noiseParameters,
