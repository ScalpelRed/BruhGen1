...
import scalpelred.Bruhgen.Bruhgen1.chunkGenerators.ChunkGenerator_RoundChunks;
...
public record ChunkFactory_RoundChunks() implements ForgeWorldPreset.IChunkGeneratorFactory {
    ...
    public ChunkGenerator createChunkGenerator(RegistryAccess registryAccess,
        ...
        return new ChunkGenerator_RoundChunks(
                structureSets,
                noiseParameters,
    ...
    public WorldGenSettings createSettings(RegistryAccess registryAccess, long seed,
        ...
        dimensions.register(
                ...
                new LevelStem(nether.typeHolder(),
                        new ChunkGenerator_RoundChunks(
