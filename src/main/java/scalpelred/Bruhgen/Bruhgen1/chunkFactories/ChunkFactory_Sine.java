...
import scalpelred.Bruhgen.Bruhgen1.chunkGenerators.ChunkGenerator_Sine;
...
public record ChunkFactory_Sine() implements ForgeWorldPreset.IChunkGeneratorFactory {
    ...
    public ChunkGenerator createChunkGenerator(RegistryAccess registryAccess,
        ...
        return new ChunkGenerator_Sine(
                structureSets,
                noiseParameters,
