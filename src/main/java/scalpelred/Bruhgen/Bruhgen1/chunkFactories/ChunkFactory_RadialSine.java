...
import scalpelred.Bruhgen.Bruhgen1.chunkGenerators.ChunkGenerator_RadialSine;
...
public record ChunkFactory_RadialSine() implements ForgeWorldPreset.IChunkGeneratorFactory {
    ...
    public ChunkGenerator createChunkGenerator(RegistryAccess registryAccess,
        ...
        return new ChunkGenerator_RadialSine(
                structureSets,
                noiseParameters,
