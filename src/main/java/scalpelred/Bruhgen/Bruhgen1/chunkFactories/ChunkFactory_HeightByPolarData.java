...
import scalpelred.Bruhgen.Bruhgen1.chunkGenerators.ChunkGenerator_HeightByPolarData;
...
public record ChunkFactory_HeightByPolarData() implements ForgeWorldPreset.IChunkGeneratorFactory {
    ...
    public ChunkGenerator createChunkGenerator(RegistryAccess registryAccess,
        ...
        return new ChunkGenerator_HeightByPolarData(
                structureSets,
                noiseParameters,
    ...
    public WorldGenSettings createSettings(RegistryAccess registryAccess, long seed,
        ...
        dimensions.register(
                ...
                new LevelStem(nether.typeHolder(),
                        new ChunkGenerator_HeightByPolarData(
