...
import scalpelred.Bruhgen.Bruhgen1.chunkGenerators.ChunkGenerator_Sections;
...
public record ChunkFactory_Sections() implements ForgeWorldPreset.IChunkGeneratorFactory {
    ...
    public ChunkGenerator createChunkGenerator(RegistryAccess registryAccess,
        ...
        return new ChunkGenerator_Sections(
                structureSets,
                noiseParameters,
