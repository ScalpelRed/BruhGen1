...
import scalpelred.Bruhgen.Bruhgen1.chunkGenerators.ChunkGenerator_AverageBlock;
...
public record ChunkFactory_AverageBlock() implements ForgeWorldPreset.IChunkGeneratorFactory {
    ...
    public ChunkGenerator createChunkGenerator(RegistryAccess registryAccess,
        ...
        return new ChunkGenerator_AverageBlock(
                structureSets,
                noiseParameters,
    ...
    public WorldGenSettings createSettings(RegistryAccess registryAccess, long seed,
        ...
        dimensions.register(
                ...
                new LevelStem(nether.typeHolder(),
                        new ChunkGenerator_AverageBlock(
