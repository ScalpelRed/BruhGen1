...
import scalpelred.Bruhgen.Bruhgen1.chunkGenerators.ChunkGenerator_Parabola;
...
public record ChunkFactory_Parabola() implements ForgeWorldPreset.IChunkGeneratorFactory {
    ...
    public ChunkGenerator createChunkGenerator(RegistryAccess registryAccess,
        ...
        return new ChunkGenerator_Parabola(
                structureSets,
                noiseParameters,
